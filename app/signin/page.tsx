        ...
        <div className="max-w-md mx-auto">
          ...
          <Card className="scale-in interactive-card">
            <CardHeader>
              ...
              <CardDescription>Enter your credentials to access your NDLMP account</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-sm text-black hover:text-primary/80 transition-colors">
                  Forgot password?
                </Link>
              </div>
              ...
              <div className="text-center text-sm text-muted-foreground">
                ...
                <Link href="/get-started" className="text-primary hover:text-primary/80 transition-colors">
                  Get started
                </Link>
              </div>
            </CardContent>
